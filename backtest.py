...
<div class="container">
    ...
    <div class="subtitle">
        {date_from} ~ {date_to} | {total}거래일 | Target: 20일 후 상승 여부 | Generated: {datetime.now().strftime('%Y-%m-%d %H:%M')}
    </div>
    ...
    <div class="footer">
        NASDAQ Backtest Report | Model: LightGBM + TimeSeriesSplit | Target: 20-day positive return | Generated by us-market-predictor
    </div>
</div>
</body>
</html>"""
